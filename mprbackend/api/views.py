...
visit_schema = {
    ...
    "properties": {
        ...
        "processed": {
            "type": "string",
            "description": "Индикатор создания ПКО. По умолчанию установлен в false, устанавливается в true со стороны 1С при создании ПКО"
        },
        "invoice": {
            "type": "string",
            "description": "Индикатор создания накладной. По умолчанию установлен в false, устанавливается в true со стороны 1С при создании накладной"
        },
        "status": {
            "type": "integer",
